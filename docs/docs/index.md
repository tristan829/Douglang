...
If you can't get the voice, then it will default to whatever voice it can find. That isn't Twitch Chat, but I guess it will suffice.

In the future, using Amazon Polly might be an option. Until then, only hot and rich individuals can use the language to its fullest potential.